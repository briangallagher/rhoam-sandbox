...
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-base.yaml" | oc delete -n toolchain-host-operator -f -
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-baseextended.yaml" | oc delete -n toolchain-host-operator -f -
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-basedeactivationdisabled.yaml" | oc delete -n toolchain-host-operator -f -
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-advanced.yaml" | oc delete -n toolchain-host-operator -f -
